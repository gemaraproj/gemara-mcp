	...
	tests := []struct {
		...
		},
		{
			...
			validateOutput: func(t *testing.T, output OutputMigrateGemaraArtifact) {
				...
				assert.Contains(t, tc.Content, "1.0.0-rc.0")
...
`,
			...
			validateOutput: func(t *testing.T, output OutputMigrateGemaraArtifact) {
				...
				assert.Contains(t, output.Artifacts[0].Content, "1.0.0-rc.0")
